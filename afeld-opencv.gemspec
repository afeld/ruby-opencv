...
Gem::Specification.new do |s|
  s.name = "afeld-opencv"
  s.version = "0.0.6.20120713035308"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["lsxi", "ser1zw", "pcting", "afeld"]
  s.date = "2012-07-13"
  s.description = "OpenCV wrapper for Ruby\n"
  s.email = ["masakazu.yonekura@gmail.com", "", "pcting@gmail.com", "aidan.feldman@gmail.com"]
  ...
  s.homepage = "https://github.com/afeld/ruby-opencv"
  s.rdoc_options = ["--main", "README.rdoc"]
  s.require_paths = ["lib"]
  s.rubyforge_project = "afeld-opencv"
